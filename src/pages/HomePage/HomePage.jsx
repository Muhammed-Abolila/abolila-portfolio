      ...
      {loading === false ? (
        <section className="container h-full mb-20 mt-12 flex items-center justify-center lg:h-screen lg:my-0">
          <div className="w-full flex flex-wrap justify-center">
            <div className="w-full md:pb-5 pb-0  border-2 border-dashed flex flex-col justify-between items-center border-subColor order-2 lg:order-1 mt-5 lg:mt-0 lg:w-3/5">
